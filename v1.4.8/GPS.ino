/*
* This Section Controls the Operation of the uBlox MAX-6Q GPS.
* The NMEA functions are deactivated, the Navmode set to Airborne and the GPS Data is fetched using the UBX protocol.
*/
...
/*
* Get data from GPS, times out after 0.5 seconds
*/
void gps_get_data()
{
  int i = 0;
  ...
  while(1) {
    ...
    // Timeout if no valid response in 0.5 seconds
...
// Parse the Coordinates from the GPS into the proper format.
void print_lat()
{
